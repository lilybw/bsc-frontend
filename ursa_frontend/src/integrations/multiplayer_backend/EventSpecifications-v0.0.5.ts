...
// !!! Last Updated (DD/MM/YYYY HH:MM:SS CET): 28/09/2024 22:15:52 CEST !!!
...
export interface DebugInfo extends IMessage {
...
export interface PlayerJoined extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface PlayerJoinAttempt extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface PlayerJoinAccepted extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface PlayerJoinDeclined extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface PlayerLeft extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface LobbyClosing extends IMessage {
}
...
export interface PlayerLeaving extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface ServerClosing extends IMessage {
}
...
export interface EnterLocation extends IMessage {
	/** Location ID
	* go type: uint32
	*/
	id: number;
...
export interface PlayerMove extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	playerID: number;
...
export interface DifficultySelectForMinigame extends IMessage {
	/** Minigame ID
	* go type: uint32
	*/
	minigameID: number;
...
export interface DifficultyConfirmedForMinigame extends IMessage {
	/** Minigame ID
	* go type: uint32
	*/
	minigameID: number;
...
export interface PlayersDeclareIntentForMinigame extends IMessage {
}
...
export interface PlayerReadyForMinigame extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface PlayerAbortingMinigame extends IMessage {
	/** Player ID
	* go type: uint32
	*/
	id: number;
...
export interface EnterMinigame extends IMessage {
}

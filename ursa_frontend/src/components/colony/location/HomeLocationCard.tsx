...
import { STYLE_LOC_CARD_backgroundImageStyle, STYLE_LOC_CARD_descriptionContainerStyle, STYLE_LOC_CARD_lowerThirdWBackgroundStyle, STYLE_LOC_CARD_titleStyleOverwrite } from './SpacePortLocationCard';

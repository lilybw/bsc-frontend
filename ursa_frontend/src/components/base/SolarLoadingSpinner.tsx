...
const color = '30';
const planets = [
    { name: 'mercury', color: `hsl(${color}, 50%, 60%)`, size: 0.333, orbitSize: 16, speed: 6 },
    { name: 'venus', color: `hsl(${color}, 50%, 60%)`, size: 0.5, orbitSize: 20, speed: 10 },
    { name: 'earth', color: `hsl(${color}, 50%, 50%)`, size: 0.533, orbitSize: 26, speed: 14 },
    { name: 'mars', color: `hsl(${color}, 50%, 40%)`, size: 0.466, orbitSize: 32, speed: 22 },
...
const SolarLoadingSpinner: Component<LoadingSpinnerProps> = (props: LoadingSpinnerProps) => {
    ...
    return (
        <div
            class={css`
                ${spinnerStyles} ${props.styleOverwrite}
            `}
            id="solar-system-loading-spinner"
        >
            <StarryBackground
                styleOverwrite={css`

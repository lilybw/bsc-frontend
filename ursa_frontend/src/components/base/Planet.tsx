...
const Planet: Component<SpinningPlanetProps> = (props) => {
    ...
    const computedAtmosphereStyles = createMemo(
        () => css`
    ...
    const sharedImageStyles = createMemo(
        () => css`
    ...
    const computedImageContainerStyles = createMemo(
        () => css`
    ...
    const computedShadowStyles = createMemo(
        () => css`
            ${baseShadowStyles}
                ...
                <div class={computedAtmosphereStyles()} id="Atmosphere">
                    <div class={planetCutoutContainer} id="PlanetContainer">
                        <div class={computedImageContainerStyles()}>
                            <img src={currentSrc()!} alt={props.metadata.alias + `-LOD-${currentLODLevel()}`} class={sharedImageStyles()} />
                            <img src={currentSrc()!} alt={props.metadata.alias + `-LOD-${currentLODLevel()}`} class={sharedImageStyles()} />
                        </div>
                        {props.children}
